Ext.define("CaptivePortal.view.editor.LoginButtonWidget",{
    ...
    form_json: {email: {enable: false, optional: false},first_name: {enable: false, optional: false},last_name: {enable: false, optional: false},gender: {enable: false, optional: false},birth_day: {enable: false, optional: false},mobile_number: {enable: false, optional: false},password: {enable: false, optional: false}},
    trigger_type: 'Button',
    header: {
        titlePosition: 0,
        title: 'Login Button'
