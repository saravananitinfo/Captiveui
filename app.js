...
Ext.application({
    ...
    //-------------------------------------------------------------------------
    requires: ['CaptivePortal.view.accesstimepolicy.Main','CaptivePortal.view.login.Login', 'CaptivePortal.view.sites.Main', 'CaptivePortal.view.Viewport', 'CaptivePortal.util.Utility', 'CaptivePortal.Config', 'CaptivePortal.view.users.TenantList', 'CaptivePortal.view.sms_gateway.Main','Ext.window.Toast','CaptivePortal.view.template_mgmt.Main', 'CaptivePortal.view.radius_vsa.Main'],
    config: {
        userRole: '',
